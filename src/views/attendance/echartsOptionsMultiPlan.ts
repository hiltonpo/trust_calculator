...
// 退休計畫 圖表的 echart 設定檔
export function multiChartOption (markpointSVGpath: string, markpointXY: any, XLinedata: any, YLinedata: any, max: number, chartWidth: any) {
