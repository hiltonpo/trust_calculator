...
import { multiChartOption } from '@/views/attendance/echartsOptionsMultiPlan';
...
@Component
export default class multiPlan extends Vue {
  // 貨幣單位
  ...
  private setLineChartData () {
    ...
    this.lineChartOption = multiChartOption('graph', markpointXY, XLineData, YLineData, maximum(YLineData.better), this.lineChartWidth);
